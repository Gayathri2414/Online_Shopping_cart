...
public class Forgot_pass extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // String username1=jTextField1.getText();
        ...
        //String gender;
       // String sec_qn=jTextField2.getText();
        String sec_ans=jTextField3.getText();
        ...
        String query=String.format("select sec_ans from user where email='%s'",email);
        ResultSet r=s.executeQuery(query);
        r.next();
        if(r.getString(1).equals(sec_ans)){
        query=String.format("update user set password='%s' where email='%s'",password,email);
        s.execute(query);
        }
       ...
       JOptionPane.showMessageDialog(this,"Password Changed Successfully!","Changed",JOptionPane.PLAIN_MESSAGE);
